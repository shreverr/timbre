...
This is a LiveKit Agents project — the voice agent service for Timbre, a caller voice AI SaaS. It sits alongside a Next.js dashboard (`../frontend`) and a Hono API (`../api`). This project handles all voice-agent tasks and is intended to be deployed to LiveKit Cloud.
